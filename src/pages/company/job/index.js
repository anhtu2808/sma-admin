            ...
            <table className="w-full text-left border-collapse table-fixed">
                <thead className="bg-gray-50/80">
                    <tr>
                        ...
                        <th className="px-6 py-4 text-left text-[13px] font-semibold text-gray-500 tracking-wider w-[20%] text-center">Status</th>
                        <th className="px-6 py-4 text-left text-[13px] font-semibold text-gray-500 tracking-wider w-[20%]">Posted Date</th>
                        <th className="px-6 py-4 text-left text-[13px] font-semibold text-gray-500 tracking-wider w-[15%] text-right pr-12">Action</th>
                    </tr>
                </thead>
                                ...
                                <td className="px-8 py-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-sm font-bold text-gray-900 truncate" title={job.name}>
                                                {job.name}
                                            </p>
