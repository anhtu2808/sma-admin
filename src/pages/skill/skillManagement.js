        ...
        <div className="flex flex-col h-full bg-surface-light dark:bg-background-dark font-body relative">
            ...
            <div className="flex items-center justify-between px-6 py-8">
                <div className="flex-1">
                    <h2 className="text-xl font-extrabold text-neutral-900 dark:text-white tracking-tight font-heading uppercase">Detailed Skills</h2>
                    <p className="text-[11px] text-neutral-400 font-medium mt-1 uppercase tracking-widest">Manage individual technical and soft skills</p>
                </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-neutral-50 dark:bg-neutral-800/50 border-b border-neutral-200">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-[10px] font-extrabold text-neutral-400 tracking-[0.2em] uppercase">Skill Name</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold text-neutral-400 tracking-[0.2em] uppercase">Description</th>
                                <th className="px-6 py-4 text-[10px] font-extrabold text-neutral-400 tracking-[0.2em] uppercase">Category</th>
                        ...
                        <tbody className="divide-y divide-neutral-100">
                            {isLoading ? (
                                ...
                                <tr key={item.id} className="group hover:bg-neutral-50 transition-all duration-200">
                                    ...
                                    <td className="px-6 py-5 font-bold text-neutral-900 dark:text-white uppercase text-xs">{item.name}</td>
                                    <td className="px-6 py-5 text-sm text-neutral-600">{item.description || '—'}</td>
                                    ...
                                    <td className="px-6 py-5 text-right">
                                        <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-all">
                                            ...
                                            <button onClick={() => { setItemToDelete(item.id); setDeleteError(null); setIsDeleteModalOpen(true); }} className="p-2 text-neutral-400 hover:text-red-500"><Trash2 size={14} /></button>
                                        </div>
                                    </td>
                                </tr>
                            ))}
